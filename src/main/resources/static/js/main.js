...
(function ($) {
    ...
    $(".hero__slider").owlCarousel({
        ...
        onInitialized: function (e) {
            ...
            $("#noLogin").html("<span>01</span><span>" + "0" + a + "</span>");
            $("#login").html("<span>01</span><span>" + "0" + a + "</span>");
        ...
        var b = --e.item.index,
            a = e.item.count;
        $("#noLogin").html("<span> " + "0" + (1 > b ? b + a : b > a ? b - a : b) + "</span><span>" + "0" + a + "</span>");
        $("#login").html("<span> " + "0" + (1 > b ? b + a : b > a ? b - a : b) + "</span><span>" + "0" + a + "</span>");
